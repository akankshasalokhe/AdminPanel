        ...
        <div className="table-row">
          ...
          <div className="user-cell">
            <div className="user-profiles">
              <img src="https://cdn.pixabay.com/photo/2023/04/21/15/42/portrait-7942151_1280.jpg" alt="user1" className="profile-pic" />
              <FaArrowRight className="arrow-icon" />
              <img src="https://i.pinimg.com/236x/db/1f/9a/db1f9a3eaca4758faae5f83947fa807c.jpg" alt="user2" className="profile-pic" />
            </div>
