...
const ProfilePage = () => {
  ...
  <div>
    ...
    <div>
      <p style={{ marginLeft: "90px", fontWeight: "bold", fontSize: "16px" }}>Asmita Ghorpade</p>
      <p style={{ marginLeft: "130px", color: "gray", fontSize: "14px" }}>asdfgh</p>
    </div>
  </div>

   {/* BASIC INFO */}
      <CCol xs={12} md={12} className="profile-col">
      ...
      {/* PERSONAL INFO */}
      <CCol xs={12} md={12} className="profile-col">
        <CCard className="info-card personal-card">
          <CCardBody>
            <h5>Personal Info</h5>
      ...
      {/* PREFERENCES */}
      <CCol xs={12} md={12} className="profile-col">
        <CCard className="info-card preference-card">
          <CCardBody>
            <h5>Preferences</h5>
...
<CCard className="mb-4 profile-card account-info">
  <CCardBody>
...
<CCard className="mb-4 profile-card account-status">
  <CCardBody>
    ...
    <CRow>
      ...
      {/* Section 3: KYC Document */}
      <CCard className="mb-4 profile-card kyc-document">
        <CCardBody>
          <h5>KYC Document</h5>
          <div className="kyc-images">
            <img src="https://adharcarddownload.co/wp-content/uploads/2024/06/aadhaar-card.webp" alt="KYC Front" />
            <img src="https://i.pinimg.com/236x/64/69/41/646941bafe885156af9d432300efab26.jpg" alt="KYC" />
          </div>
        </CCardBody>
      </CCard>

      {/* Section 4: Gallery */}
      <CCard className="mb-4 profile-card gallery-section">
        <CCardBody>
          <h5>Gallery</h5>
      ...
      <CCard className="mb-4 profile-card user-activity">
        <CCardBody>
          <h5>User Activity</h5>
          <ul>
